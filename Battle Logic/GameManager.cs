...
{   
    ...
    void EnemyTurn() {
        ...
        if(enemy.attack) {
            enemy_act.text = enemy.damaged.ToString();
            if(character.cur_Player_Defense_cut - enemy.damaged >= 0) {
                character.cur_Player_Defense_cut -= enemy.damaged;
            }
            else {
                character.cur_Player_HP -= enemy.damaged - character.cur_Player_Defense_cut;
            }
